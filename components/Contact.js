...
const Contact = () => {
    ...
    return (
        <div className={contactStyles.contactSection} id="contact" >
            ...
            <div className={contactStyles.formContainer}>
                ...
                <form name="contact" method="POST" data-netlify="true" className={contactStyles.form}>
                    ...
                    <motion.label ref={ref} initial="hidden" animate={controls} variants={{
                        hidden: { scale: 0 },
                        visible: { scale: 1, transition: { delay: .5 } }
                    }} htmlFor="name" className={contactStyles.formLabel}>Name:</motion.label>
                    <motion.input ref={ref} initial="hidden" animate={controls} variants={{
                        hidden: { scale: 0 },
                        visible: { scale: 1, transition: { delay: .75 } }
                    }} className={contactStyles.formInput} type="text" id="name" name="name" />
                    ...
                    <motion.label ref={ref} initial="hidden" animate={controls} variants={{
                        ...
                        htmlFor="email"
                        className={contactStyles.formLabel}>E-Mail:</motion.label>
                    <motion.input ref={ref} initial="hidden" animate={controls} variants={{
                        hidden: { scale: 0 },
                        visible: {
                            scale: 1,
