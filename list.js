...
export const projectsList = [
    {
        ...
        text: "“Having Fun is the Best Way to Learn” (Albert Einstein). Our Software Development journey began in 2017 with 2D arcade games. Brain 2.0 made use of Unity 2D's engine to build an enldess runner game called RUN! and a flappy bird clone called Flappy Brain. Both games were available on the Google Play Store from 2017 until 2019.",
    ...
    },
    {
        ...
        date: "September 2019",
        logo: "/oneinstock.png",
        shortDesc: "Where exclusivity meets quality",
        text: "In 2019, Brain 2.0 launched its first E-Commerce Web-Store. OneInStock's purpose was making the customer's shopping experience as enjoyable as possible on a fluid interface using a custom-built e-commerce website. In Lebanon, most online stores charge a very high commission for their stock. Brain 2.0 wanted to elevate the e-commerce sector by offering limited edition items for a very cheap price which was intended force other stores to offer competitive prices, hence reducing the average commission. We also offered free gifts with each order along with a handwritten thank you letter to build a connection with our customers. The store only had 1 item in stock which helped the user make faster decisions. Due to unfortunate circumstances, Lebanon started its worst economic crisis in October 2019, 1 month after the website's launch. In January 2020, Lebanese banks blocked transactions using foreign currencies which meant we could not fund the hosting of OneInStock.me and had to revert to an Instagram-based store. From October until December 2019, we were recruiting Instagram-based stores to give them a free platform to advertise their products on OneInStock.me we had many stores ready to join the OneInStock.me ecosystem but due to the Lebanese banks' measures, the operation was halted. OneInStock became a profitable business 6 months after its lauch and the store still operates on Instagram.",
