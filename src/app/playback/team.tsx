        ...
        <section className="bg-[#B8B9A2] text-[var(--dark-grey)]">
            <div className="container px-5 py-24 mx-auto">
                <div className="flex flex-col text-center w-full mb-20">
                    ...
                    <p className="lg:w-2/3 mx-auto leading-relaxed text-base">The project&lsquo;s backbone, the <span className='font-bold'>TEAM</span>, is working hard to onboard as many players, clubs, and venues as possible and enable you to start elevating your experience.</p>
                </div>
