...
export default function About() {
    return (
        <section className="flex flex-row justify-start items-center overflow-scroll bg-[var(--teal)]">
            ...
            <div className="w-full flex flex-col p-4 md:p-12 items-center">
                ...
                <div className="flex flex-col justify-center items-center">
                    <p className="text-white md:text-xl text-xs">
                        ...
                        Established in 2017 as a pioneering software development firm, <span className="font-bold text-white">BRAIN<span className="inter-font font-light">2.0</span></span>  has evolved into a multifaceted solutions innovator. Embodying our ethos, &rsquo;Driven by Values, Powered by Intellect&rsquo;, we are committed to leveraging intellectual prowess to deliver value-driven solutions for a diverse range of needs, catering to both individuals and businesses.<br /> <br />

                        At <span className="font-bold text-white">BRAIN<span className="inter-font font-light">2.0</span></span>, we don&rsquo;t just create software; we engineer a spectrum of revolutionary solutions. Our flagship division, <span className="font-bold text-white">SOFTWARE<span className="inter-font font-light">2.0</span></span>, continues our legacy of crafting efficient software solutions that simplify complexities, ensuring user-friendly experiences backed by robust, sophisticated processes.<br /> <br />
