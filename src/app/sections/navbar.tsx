...
const navLinks = [
  ...
  { label: 'Gotcha', href: '#gotcha' },
  { label: 'PLAYBACK', href: '#playback' },
  { label: 'Content', href: '#content' },
  { label: 'CoPilot', href: '#freelance' },
]
    ...
    >
      <div className="max-w-7xl mx-auto px-6 py-4 flex items-center justify-between">
        ...
        <Sheet open={open} onOpenChange={setOpen}>
          <SheetTrigger className="md:hidden inline-flex items-center justify-center rounded-lg p-2 text-b2-light hover:bg-white/5 transition-colors">
