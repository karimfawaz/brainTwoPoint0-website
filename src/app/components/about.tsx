    ...
    return (
        <section className="snap-center flex flex-row justify-start items-center overflow-scroll no-scrollbar">
            <div className="flex flex-col justify-center items-center h-full w-1/5 md:w-40">
                <h1 className="font-bold text-7xl md:text-[6.5rem] text-white rotate-90">ABOUT<span className="font-[100] inter-font">US</span></h1>
            </div>
            <div className="w-full min-h-screen flex flex-col p-4 md:p-12 items-center">
                <h1 className="font-bold text-[var(--light)] md:text-6xl text-xl mb-3 md:mb-6 w-full">BRAIN 2.<span className="font-[100] inter-font">&quot;OOH&quot;</span></h1>
                <div className="flex flex-col justify-center items-center">
                    <p className="text-[var(--light)] md:text-base text-[9px]">
                ...
                <div className="flex w-2/3 snap-x overflow-scroll border mt-2 md:mt-8 p-2 space-x-4 rounded-lg">
                    <Image alt="Brain 2.0 Logo Redesign" src="/redesign/1.png" width={250} height={250} className="snap-center md:h-40 md:w-40 min-[2000px]:h-60 min-[2000px]:w-60" />
                    <Image alt="Brain 2.0 Logo Redesign" src="/redesign/2.png" width={250} height={250} className="snap-center md:h-40 md:w-40 min-[2000px]:h-60 min-[2000px]:w-60" />
                    <Image alt="Brain 2.0 Logo Redesign" src="/redesign/3.png" width={250} height={250} className="snap-center md:h-40 md:w-40 min-[2000px]:h-60 min-[2000px]:w-60" />
                    <Image alt="Brain 2.0 Logo Redesign" src="/redesign/4.png" width={250} height={250} className="snap-center md:h-40 md:w-40 min-[2000px]:h-60 min-[2000px]:w-60" />
                    <Image alt="Brain 2.0 Logo Redesign" src="/redesign/5.png" width={250} height={250} className="snap-center md:h-40 md:w-40 min-[2000px]:h-60 min-[2000px]:w-60" />
                </div>
            </div>
        </section>
    )
