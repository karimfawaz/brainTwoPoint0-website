    ...
    return (
        <section className="text-gray-600 body-font bg-[var(--light)]">
            <div className="container px-5 py-24 mx-auto">
                ...
                <Link href="/contact"><button className="flex mx-auto mt-16 text-[var(--light)] bg-[var(--dark-grey)] py-2 px-8 border-2 border-[var(--dark-grey)] focus:outline-none hover:bg-[var(--light)] font-bold text-lg hover:text-[var(--dark-grey)]">REACH<span className='font-thin'>OUT</span></button></Link>
            </div>
        </section>
