    ...
    return (
        <section className="w-full bg-white">
            <div className="w-full px-4 py-20 mx-auto text-center md:w-3/4 lg:w-2/4">
                ...
                <h2 className="mb-6 text-3xl font-extrabold tracking-tight md:text-4xl md:mb-6 md:leading-tight text-[var(--dark-grey)]">Reach out and let us know how we can help</h2>
