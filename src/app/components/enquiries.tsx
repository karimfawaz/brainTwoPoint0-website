    ...
    return (
        <section className="w-full bg-white">
            <div className="w-full px-4 py-20 mx-auto text-center md:w-3/4 lg:w-2/4">
                ...
                <button className="flex mx-auto text-[var(--light)] bg-[var(--dark-grey)] py-2 px-8 border-2 border-[var(--dark-grey)] focus:outline-none hover:bg-white font-bold text-lg hover:text-[var(--dark-grey)]"><Link href="/contact">ENQUIRIES</Link></button>
